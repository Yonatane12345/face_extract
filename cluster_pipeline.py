...
if __name__ == "__main__":
    ...
    """
    faces_path = "D:\\OneDrive\\OneDrive - mail.tau.ac.il\\python\\face_detection\\TwoPauz\\Faces"
    
    ''' Detect landmark for each face '''
    landmarks = landmark(faces_path)
    print("Detected landmarks")
    
    ''' Cluster the  faces by their landmarks '''
    labels = cluster(landmarks)
